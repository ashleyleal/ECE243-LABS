...
key0:
	xori INPUT_REG, INPUT_REG 0x0 # Toggle 0
	movia   DISPLAY_REG, 0x0      # HEX0 for display
	call HEX_DISP
key1:
	xori INPUT_REG, INPUT_REG 0x1 # Toggle 1
	movia   DISPLAY_REG, 0x1      # HEX1 for display
	call HEX_DISP
key2:
	xori INPUT_REG, INPUT_REG 0x2 # Toggle 2
	movia   DISPLAY_REG, 0x2      # HEX2 for display
	call HEX_DISP
key3:
	xori INPUT_REG, INPUT_REG 0x3 # Toggle 3
	movia   DISPLAY_REG, 0x3      # HEX3 for display
	call HEX_DISP
